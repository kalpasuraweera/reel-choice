      ...
      <Box sx={{ flexGrow: 1, m: 2 }}>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Typography variant="body2">
              ...
              top-notch services to our clients. We started as a small team with
              a big vision, and we have grown into a successful company with a
              strong reputation. Our expertise lies in creating innovative
              solutions that meet the unique needs of our clients. We are proud
              of our track record of delivering high-quality products and
              exceeding customer expectations. Our team is made up of talented
              individuals who are passionate about what they do and are
              dedicated to delivering exceptional results. We believe in
              fostering a collaborative and inclusive work environment where
              everyone's ideas are valued. Together, we strive to make a
        ...
        >
          <Grid
            ...
            sx={{
              backgroundImage:
                "url(/MIDR1_US_2023_Amazon_1920x1080_2538342_1920x1080.jpg)",
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    transforms ideas into visual stories. Her innovative
                    approach and dedication to brand identity have elevated our
                    marketing materials and product designs. Mia's leadership in
                    the creative department has inspired a culture of creativity
                    and excellence. When not at work, she enjoys photography and
                    traveling.
                  </Typography>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    scalable and efficient server-side applications. His
                    expertise in various backend technologies has been
                    instrumental in building robust architectures for our
                    products. Leo is passionate about coding and often
                    contributes to open-source projects. In his leisure time, he
                    enjoys cycling and playing the guitar.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
